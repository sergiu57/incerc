        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                ...
                <form method="POST" action="creare-cont.php">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="password" type="password" class="form-control" name="parola1" required>
                    </div>
                    <div class="form-group col-6">
                      <label for="password2" class="d-block">Repeta parola</label>
                      <input id="password2" type="password" class="form-control" name="parola2" required>
                    </div>
                  </div>

                  <div class="form-group">
                    <button type="submit" name="creare_cont" class="btn btn-primary btn-lg btn-block">
                      Creare cont
                    </button>
                  </div>
                </form>
            ...
            <div class="mt-3 mb-5 text-muted text-center">
              Ai deja un cont? <a href="conectare.php">Conectare</a>
            </div>
          </div>
        </div>
      </div>
