        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <a href="profil.php?id=<?php echo $user['id']; ?>" class="dropdown-item has-icon">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <a href="conectare.php" class="dropdown-item has-icon">
                <i class="fas fa-sign-in-alt"></i> Conectare
              </a>
              <a href="creare-cont.php" class="dropdown-item has-icon">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="profil.php?id=<?php echo $user['id']; ?>"><i class="fas fa-user"></i> <span>Profil</span></a></li>
            ...
            <?php else: ?>
            <li class="menu-header">Cont</li>
            <li><a class="nav-link" href="conectare.php"><i class="fas fa-sign-in-alt"></i> <span>Conectare</span></a></li>
            <li><a class="nav-link" href="creare-cont.php"><i class="fas fa-user-plus"></i> <span>Creare cont</span></a></li>
            <?php endif ?>
          </ul>
        </aside>
      </div>