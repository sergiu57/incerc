              ...
              <div class="card-body">
                <form method="POST" action="conectare.php">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control" name="parola" tabindex="2" required>
                  </div>

                  <div class="form-group">
                    <button type="submit" name="conectare" class="btn btn-primary btn-lg btn-block" tabindex="4">
                      Conectare
                    </button>
                  </div>
                </form>
